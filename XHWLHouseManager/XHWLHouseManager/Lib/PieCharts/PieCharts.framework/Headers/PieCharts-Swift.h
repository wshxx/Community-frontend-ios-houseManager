...
@property (nonatomic) CGFloat selectedOffset;
...
@property (nonatomic) CGFloat referenceAngle;
@property (nonatomic, readonly, strong) CALayer * _Nonnull container;
@property (nonatomic, readonly) double totalValue;
...
@interface PieChart (SWIFT_EXTENSION(PieCharts))
@end
...
@property (nonatomic) CGFloat outerRadius;
@property (nonatomic) CGFloat selectedOffset;
@property (nonatomic, readonly) CGPathRef _Nullable path;
@property (nonatomic, readonly) CGFloat midAngle;
@property (nonatomic, readonly) CGPoint arcCenter;
@property (nonatomic) BOOL selected;
- (nonnull instancetype)initWithColor:(UIColor * _Nonnull)color startAngle:(CGFloat)startAngle endAngle:(CGFloat)endAngle animDelay:(double)animDelay center:(CGPoint)center OBJC_DESIGNATED_INITIALIZER;
...
- (CGPoint)calculatePositionWithAngle:(CGFloat)angle p:(CGPoint)p offset:(CGFloat)offset SWIFT_WARN_UNUSED_RESULT;
- (CGPoint)midPointWithRadius:(CGFloat)radius SWIFT_WARN_UNUSED_RESULT;
- (CGFloat)maxRectWidthWithCenter:(CGPoint)center height:(CGFloat)height SWIFT_WARN_UNUSED_RESULT;
