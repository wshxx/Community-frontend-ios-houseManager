...
const CGFloat kHZFontSize = 14.f;
...
- (void)cancelButtonClicked
{
    ...
    if ([_delegate respondsToSelector:@selector(sheet:clickIndex:)]) {
        [_delegate sheet:self clickIndex:_cancelButtonIndex];
    }
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([_delegate respondsToSelector:@selector(sheet:clickIndex:)]) {
        [_delegate sheet:self clickIndex:indexPath.row];
    }
}
@end
