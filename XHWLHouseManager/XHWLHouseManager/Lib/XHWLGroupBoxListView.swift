...
class XHWLGroupBoxListView: UIView {
...
//        self.addSubview(self.spaceLine)
        ...
        self.boxArrow = UIImageView(image: UIImage(named: "Patrol_arrow"))
        self.boxButton.addSubview(self.boxArrow)
        
//        let parentFrame = parentVC.view!.frame
        let parentFrame = UIScreen.main.bounds
...
//        parentVC.view.addSubview(self.boxWrapperView)
        window.addSubview(self.boxWrapperView)
    ...
    override func layoutSubviews() {
        ...
        self.boxTitle.frame.size = CGSize(width: self.frame.size.width - img.size.width, height: self.frame.size.height)
...
extension XHWLGroupBoxListView: UITableViewDelegate {
...
extension XHWLGroupBoxListView: UITableViewDataSource {
