...
static CGFloat const kHooDatePickerHeaderBottomMargin = 0.5f;
...
static CGFloat const kHooDatePickerPadding = 0.0f;

// Constants times :
static CGFloat const kHooDatePickerAnimationDuration = 0.4f;

// Constants fonts
#define kHooDatePickerTitleFont [UIFont systemFontOfSize:14.0]
#define kHooDatePickerLabelFont [UIFont systemFontOfSize:14.0]
#define kHooDatePickerLabelSelectedFont [UIFont systemFontOfSize:14.0];

// Constants colors :
#define kHooDatePickerTintColor [UIColor colorWithRed:172/255.0 green:172/255.0 blue:172/255.0 alpha:1]
#define kHooDatePickerHighlightColor [UIColor colorWithRed:88/255.0 green:88/255.0 blue:88/255.0 alpha:1]
...
- (NSMutableArray *)months {
    ...
    for (int monthNumber = 1; monthNumber <= 12; monthNumber++) {
        NSString *dateString = [NSString stringWithFormat: @"%d%@", monthNumber, LocalLanguage(@"yue")];
...
- (NSMutableArray*)hours {
    if (!_hours) {
        ...
        for (int i = 0; i < 24; i++) {
            if (i < 10) {
                [hours addObject:[NSString stringWithFormat:@"0%d%@", i, LocalLanguage(@"shid")]];
            } else {
                [hours addObject:[NSString stringWithFormat:@"%d%@", i, LocalLanguage(@"shid")]];
            }
        }
        _hours = hours;
    }
...
- (NSMutableArray*)minutes {
    if (!_minutes) {
        ...
        for (int i = 0; i < 60; i++) {
            if (!i) {
                [minutes addObject:[NSString stringWithFormat:@"%d0%@", i, LocalLanguage(@"fen")]];
            } else {
                [minutes addObject:[NSString stringWithFormat:@"%d%@", i, LocalLanguage(@"fen")]];
            }
