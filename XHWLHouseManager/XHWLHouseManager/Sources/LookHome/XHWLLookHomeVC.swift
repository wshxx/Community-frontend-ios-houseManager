...
class XHWLLookHomeVC: UIViewController {
...
//        self.navigationController?.pushViewController(vc, animated: true)
    ...
    func customStyle() -> ESTabBarController {
        ...
        let v1 = XHWLNavigationController(rootViewController:XHWLHomeVC())
        let v2 = XHWLNavigationController(rootViewController:XHWLWorkVC())
        
        v1.tabBarItem = ESTabBarItem.init(title: "首页", image: UIImage(named: "tabbar_1"), selectedImage: UIImage(named: "tabbar_1"))
        v2.tabBarItem = ESTabBarItem.init(title: "工作", image: UIImage(named: "tabbar_2"), selectedImage: UIImage(named: "tabbar_2"))
