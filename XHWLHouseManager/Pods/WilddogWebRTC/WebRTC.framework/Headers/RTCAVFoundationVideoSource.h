...
@protocol RTCAVFoundationVideoSourceDelegate <NSObject>

- (CVPixelBufferRef)videoSource:(RTCAVFoundationVideoSource *)videoSource didOutputPixelBuffer:(CVPixelBufferRef)pixelBuffer;
...
@property (nonatomic, weak) id<RTCAVFoundationVideoSourceDelegate> delegate;
@end
